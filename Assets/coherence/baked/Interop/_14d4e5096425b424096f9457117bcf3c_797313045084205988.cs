...
namespace Coherence.Generated
{
    ...
    public struct _14d4e5096425b424096f9457117bcf3c_797313045084205988 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= _14d4e5096425b424096f9457117bcf3c_797313045084205988.positionMask;
            positionSimulationFrame = frame;
            FieldsMask |= _14d4e5096425b424096f9457117bcf3c_797313045084205988.rotationMask;
            rotationSimulationFrame = frame;
        }

        public static unsafe _14d4e5096425b424096f9457117bcf3c_797313045084205988 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 28) {
            ...
            var orig = new _14d4e5096425b424096f9457117bcf3c_797313045084205988();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & _14d4e5096425b424096f9457117bcf3c_797313045084205988.positionMask) != 0 && (min == null || this.positionSimulationFrame < min))
            {
                min = this.positionSimulationFrame;
            }
            if ((FieldsMask & _14d4e5096425b424096f9457117bcf3c_797313045084205988.rotationMask) != 0 && (min == null || this.rotationSimulationFrame < min))
            {
        ...
        {
            var other = (_14d4e5096425b424096f9457117bcf3c_797313045084205988)data;
        ...
        public static uint Serialize(_14d4e5096425b424096f9457117bcf3c_797313045084205988 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static _14d4e5096425b424096f9457117bcf3c_797313045084205988 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new _14d4e5096425b424096f9457117bcf3c_797313045084205988();
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= _14d4e5096425b424096f9457117bcf3c_797313045084205988.positionMask;
            }
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= _14d4e5096425b424096f9457117bcf3c_797313045084205988.rotationMask;
            }
        ...
        {
            return $"_14d4e5096425b424096f9457117bcf3c_797313045084205988(" +
