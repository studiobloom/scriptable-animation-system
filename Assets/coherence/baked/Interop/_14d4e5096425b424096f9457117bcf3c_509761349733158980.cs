...
namespace Coherence.Generated
{
    ...
    public struct _14d4e5096425b424096f9457117bcf3c_509761349733158980 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= _14d4e5096425b424096f9457117bcf3c_509761349733158980.positionMask;
            positionSimulationFrame = frame;
            FieldsMask |= _14d4e5096425b424096f9457117bcf3c_509761349733158980.rotationMask;
            rotationSimulationFrame = frame;
        }

        public static unsafe _14d4e5096425b424096f9457117bcf3c_509761349733158980 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 28) {
            ...
            var orig = new _14d4e5096425b424096f9457117bcf3c_509761349733158980();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & _14d4e5096425b424096f9457117bcf3c_509761349733158980.positionMask) != 0 && (min == null || this.positionSimulationFrame < min))
            {
                min = this.positionSimulationFrame;
            }
            if ((FieldsMask & _14d4e5096425b424096f9457117bcf3c_509761349733158980.rotationMask) != 0 && (min == null || this.rotationSimulationFrame < min))
            {
        ...
        {
            var other = (_14d4e5096425b424096f9457117bcf3c_509761349733158980)data;
        ...
        public static uint Serialize(_14d4e5096425b424096f9457117bcf3c_509761349733158980 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static _14d4e5096425b424096f9457117bcf3c_509761349733158980 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new _14d4e5096425b424096f9457117bcf3c_509761349733158980();
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= _14d4e5096425b424096f9457117bcf3c_509761349733158980.positionMask;
            }
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= _14d4e5096425b424096f9457117bcf3c_509761349733158980.rotationMask;
            }
        ...
        {
            return $"_14d4e5096425b424096f9457117bcf3c_509761349733158980(" +
